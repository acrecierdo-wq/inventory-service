          ...
          <tr key={`${item.id}-${index}`} className="hover:bg-gray-50">
            ...
            <td className="border border-[#173f63] px-3 py-2">{item.quantity}</td>
              ...
              <div className="w-1/2 flex flex-col">
                ...
                <div className="text-right font-sans text-sm mt-2 font-bold text-[#44164e]">STATUS: Received</div>
                ...
                <div className="mt-8 self-end flex gap-2">
                  ...
                  >
                    <Link href="/customer/my_orders/track_my_order/view_details">Back</Link>
                  </Button>
                </div>
...
export default ViewDetailsRCPage;