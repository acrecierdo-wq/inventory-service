        ...
        <div className="flex justify-center flex-col items-center mt-5">
          <div className="bg-white w-[1200px] rounded-xl p-6">
            <div className="bg-gradient-to-r from-[#0c2a42] to-[#476886] w-full h-15 rounded-xl px-5 py-2">
              <div className="text-white font-semibold text-lg">PURCHASE ORDER</div>
              <div className="text-white text-sm">Linked Quotation: #0001</div>
            </div>

            <div className="flex justify-between text-[#777777] text-xs mt-3">
              <div className="ml-2">
                <span className="font-bold">Purchase Order from:</span><br />
                Canlubang Techno-Preneurship Industrial Corporation<br />
                Siranglupa, Canlubang, Calamba City, 4027<br />
                000-0000-000
              </div>
              <div className="mr-2 text-right">
                <span className="font-bold">Purchase Order to:</span><br />
                Canlubang Techno-Preneurship Industrial Corporation<br />
                Siranglupa, Canlubang, Calamba City, 4027<br />
                000-0000-000
              </div>
            ...
            <div className="text-[#44164e] font-semibold ml-2 mt-2">Purchase Order Details</div>
...
>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-5 flex items-center justify-center z-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-[350px]">
      <h2 className="text-lg font-semibold text-gray-800">Confirm Upload</h2>
      <p className="text-sm text-gray-600 mt-2">
        Are you sure you want to upload this purchase order?
      </p>
...
export default ViewDetailsCPOPage;
