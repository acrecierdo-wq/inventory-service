          ...
          <div className="bg-white w-[1200px] rounded-xl p-6">
            ...
            <div className="flex justify-between">
              <div className="text-white font-semibold text-lg">
                Quotation #0001
              <div className="text-white text-sm font-normal">Type: Services</div>  
                </div>
  ...
  <div className="overflow-x-auto">
    <table className="w-full text-sm text-left border border-[#173f63] b-2 rounded-lg">
      <thead className="bg-[#476886] text-[#ffffff]">
        <tr>
          <th className="border border-[#173f63] px-3 py-2">Material</th>
          <th className="border border-[#173f63] px-3 py-2">Type</th>
          <th className="border border-[#173f63] px-3 py-2">Size / Unit</th>
      ...
      <tbody>
        {(selectedItems.length > 0 ? selectedItems : [
          { id: '1', name: 'Stainless Steel', type: 'Sheet', unit: '250MM x 500MM', quantity: 2, price: '1,800' },
          { id: '2', name: 'Acrylic', type: 'Rod', unit: '12MM x 1M', quantity: 4, price: '2,400' },
          { id: '3', name: 'Mild Steel', type: 'Plate', unit: '300MM x 300MM', quantity: 3, price: '3,000' },
        ]).map((item, index) => (
          <tr key={`${item.id}-${index}`} className="hover:bg-gray-50">
            <td className="border border-[#173f63] px-3 py-2">{item.name}</td>
            <td className="border border-[#173f63] px-3 py-2">{item.type || '—'}</td>
...
<div className="bg-[#fef4e4] p-3 rounded mt-1 text-xs text-[#482b0e] w-[700px] leading-relaxed">
  <ul className="list-disc pl-5">
    ...
    <li>Work will commence only after receiving a signed Purchase Order (PO).</li>
    <li>Final output depends on the specifications/sketches provided by the client.</li>
    <li>Lead time may vary depending on service complexity and material availability.</li>
    <li>Changes or revisions after confirmation may incur additional charges.</li>
    <li>50% downpayment is required before the start of service (unless otherwise agreed).</li>
  </ul>
</div>
                  ...
                  <div className="flex flex-col pl-5">
                   <div className="text-[#482b0e] font-semibold mt-4 font-sans">
                    ...
                    <div className="text-white font-bold ml-3">TOTAL: PHP 10,500</div>
                    </div>
                  </div>
                  </div>
...
export default OHQuotationNCPage;