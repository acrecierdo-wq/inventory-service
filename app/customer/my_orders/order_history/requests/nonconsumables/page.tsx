...
const RequestsNonConsumablesPage = () => {
    ...
    <div className="bg-[#fed795] h-full w-full min-h-screen">
        <CustomerHeader />
                <div className="flex justify-center flex-col items-center mt-5">
                  <div className="bg-white w-[1200px] rounded-xl p-5 h-[600px]">
                    ...
                    <div className="flex flex-row mt-2 gap-4">
                      {/* Upload area */}
                      <div className="w-1/2">
                        <div className="h-[160px] w-full bg-white rounded border-[3px] border-dashed flex flex-col justify-center items-center"
                        >
                          <Image
                            ...
                            alt="upload"
                          />
                          <div className="text-[#44164e] text-center mt-2">
                ...
                <div className="text-">Urgent Delivery Date: <br></br><br></br>May 7, 1015 | 7:00 AM<br></br><br></br><br></br>Thank You!</div>
                        ...
                        {/* Buttons */}
                        <div className="mt-25 self-end flex gap-2">
                        <Button
...
export default RequestsNonConsumablesPage;