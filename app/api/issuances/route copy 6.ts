...
//           normalize(itemData.sizeId) !== normalize(item.sizeId) ||
//           normalize(itemData.variantId) !== normalize(item.variantId) ||
//           normalize(itemData.unitId) !== normalize(item.unitId)
//         ) {
//           return NextResponse.json(
//             { error: `Mismatch: Item ID does not match provided name, size, variant, and unit.`, },
//             { status: 400 }
//           );
//         }
