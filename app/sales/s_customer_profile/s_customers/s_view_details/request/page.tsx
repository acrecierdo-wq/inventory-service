...
const SalesViewDetailsCRPage = () => {
  ...
  const handleSave = () => {
    ...
    router.push("/sales/s_customer_profile/s_customers/s_view_details_c");
  };

  return (
    <SalesClientComponent>
      <div className="bg-[#ffedce] h-full w-full min-h-screen">
        <Header />
          ...
          <div className="bg-white w-[1200px] rounded-xl p-6">
            ...
            <div className="flex flex-row mt-2 gap-4">
              ...
              <div className="w-1/2 flex flex-col">
                <div className="text-[#44164e] font-semibold">Mode:
                  <div className="h-8 w-full mt-1 rounded border border-gray-300 bg-white px-2 text-sm text-gray-700">
                    <div className="mt-1">Delivery</div>
                  </div>
                </div>

                <div className="text-[#44164e] font-semibold mt-4">Message:</div>
                <div className="bg-[#fef4e4] p-3 rounded mt-1 text-xs text-[#482b0e]">
                  <div className="text-">
                    Urgent Delivery Date: <br></br><br></br>May 7, 1015 | 7:00 AM<br></br><br></br><br></br>Thank You!
                  </div>
                </div>
                ...
                <div className="mt-8 self-end flex gap-2">
                  ...
                  >
                    <Link href="/sales/s_customer_profile/s_customers/s_view_details_c">Back</Link>
                  </Button>
                  <Button
                    variant="superOutline"
...
export default SalesViewDetailsCRPage;
