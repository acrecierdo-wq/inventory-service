      ...
      <div className="bg-[#fed795] h-full w-full min-h-screen">
        ...
        <div className="flex justify-center flex-col items-center mt-3">
          <div className="bg-white w-[1200px] rounded-xl p-6">
            ...
            {/* Buttons */}
            <div className="ml-220 mt-8 self-end flex gap-2">
                  <Button
                    variant="superOutline"
                    className="h-8 w-30 px-2 py-1 rounded-4xl shadow-lg bg-[#a72227] hover:bg-gray-100 border-gray-400 hover:text-[#ffffff] text-[#ffffff]"
                  >
                    <Link href="/sales/s_customer_profile/s_customers/s_view_details_c">Remark</Link>
                  </Button>
                  <Button
                    variant="superOutline"
                    className="h-8 w-30 px-2 py-1 text-sm rounded-4xl shadow-lg bg-[#2b9630] hover:bg-gray-300 border-gray-400 hover:text-[#ffffff] text-[#ffffff]"
                  >
                    <Link href="/sales/s_customer_profile/s_customers/s_view_details_c">Send</Link>
                  </Button>
                </div>
...
export default SalesViewDetailsCQPage;
