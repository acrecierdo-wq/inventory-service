...
const SalesRequestConsumablesPage = () => {
  ...
  const handleSave = () => {
    ...
    router.push("/sales/sales_requests/s_consumables_request");
  };
            ...
            <div className="flex flex-row mt-2 gap-4">
              ...
              <div className="w-1/2 flex flex-col">
                ...
                <div className="mt-8 self-end flex gap-2">
                  ...
                  >
                    <Link href="/sales/sales_requests/s_consumables_request">Back</Link>
                  </Button>
                  <Button
                    variant="superOutline"
...
export default SalesRequestConsumablesPage;
