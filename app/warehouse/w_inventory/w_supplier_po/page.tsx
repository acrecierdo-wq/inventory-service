...
const WarehouseSupplierPOPage = () => {
    return (
        ...
        <div className="bg-[#ffedce] h-full w-full">
            ...
            <Header />
            {/* Add New PO */}
            <div className="pl-282 mt-5 flex flex-row">
                ...
                <div className="h-100 w-310 bg-[#ededed] flex flex-col">
                    ...
                    <div className="h-13 w-310 bg-[#fef4e4]">
                        <div className="flex flex-row ">
                            ...
                            <Link href="/">
                            <div className="mt-3">
                            <span className="text-[#5a4632] ml-34 pl-4 pr-4 pt-0 pb-0 border-[#d2bda7] border-b-4 bg-white rounded-3xl shadow-2xl cursor-pointer">
                             Update Inventory
                            </span>
                            </div>
                            </Link>
...
export default WarehouseSupplierPOPage;