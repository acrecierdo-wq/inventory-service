...
//     // function formatIssuedAt(status: string, issuedAt: string | null) {
//     //     if (!issuedAt) {
//     //         return status === "Draft" ? "Draft(-)" : "-";
//     //     }
//     //     const formatted = format(new Date(issuedAt), "MMM dd, yyyy hh: mm a");
...
//                     <div className="h-5 w-15 mt-3  bg-white border-b-2 border-green-800 rounded-md flex items-center justify-center cursor-pointer hover:bg-[#f0d2ad] active:border-b-4">
//                         <span className="text-xs text-green-800">Issued</span>
//                     </div>
//                 </div>

//                 {/* Draft Tab */}
//                 <div className="relative">
//                     <div className="h-5 w-15 mt-3  bg-white border-b-2 border-slate-800 rounded-md flex items-center justify-center cursor-pointer hover:bg-[#f0d2ad] active:border-b-4">
...
//                 {/* Archived Tab */}
//                 <div className="relative">
//                     <div className="h-5 w-15 mt-3  bg-white border-b-2 border-red-800 rounded-md flex items-center justify-center cursor-pointer hover:bg-[#f0d2ad] active:border-b-4">
...
//                 {!loading && ! error && (
//                 <>
//                 <div className="grid grid-cols-6 gap-4 px-5 py-3 text-[#5a4632] font-semibold border-b border-[#d2bda7] text-center">
//                 <span>CLIENT</span>
//                 <span>DATE | TIME</span>
...
//                     <div 
//                     key={issuance.id} 
//                     className="grid grid-cols-6 gap-4 px-5 py-2 bg-white border-b border-gray-200 text-[#1e1d1c] text-center"
//                     >
