// app/warehouse/replenishment_log/replenishment_action.tsx
...
import { Replenishment, ReplenishmentItemDetail } from "@/app/warehouse/replenishment_log/types/replenishment";
...
const ReplenishmentActions = ({ item, onDelete, onRestore }: ReplenishmentActionsProps) => {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Error archiving replenishment.");
    }
  };
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent>
          <SheetHeader>
            <SheetTitle className="text-center font-bold text-2xl underline">Replenishment Details</SheetTitle>
          </SheetHeader>
          ...
          <div className="flex items-center gap-2"><span><strong>Status:</strong></span>
            ...
            className={`px-2 py-0.5 rounded text-sm font-medium ${
              item.status === 'Replenished' ? 'bg-green-200 text-green-800' :
      ...
      <AlertDialog open={confirmDelete} onOpenChange={setConfirmDelete}>
        ...
        <AlertDialogContent>
          ...
          <p>This will archive the selected replenishment log record.</p>
