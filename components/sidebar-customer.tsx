// components/sidebar-customer.tsx
    ...
    return (
        <div className={cn
            (" flex h-full w-[250px] fixed left-0 top-0 gap-y-2 px-4 flex-col bg-gradient-to-t  from-[#fff6f5] to-[#ffffff] shadow-2xl",
                ...
                <Link href="/customer/customer_dashboard">
                ...
                <div className="flex flex-col gap-y-1 flex-">
                    <SidebarItem
                    label="Dashboard" 
                    href="/customer/customer_dashboard" 
                    ...
                    href="/customer/s_CustomerProfile" 
                    iconSrc="/board-chart-svgrepo-com.svg"
                    onClick={closeAllDropdowns}
                    />
                    ...
                    <div className="pl-2 flex flex-col">
                        <SidebarItem
                        label="Consumables" 
                        href="/customer/customer_requests/s_consumables_request" 
