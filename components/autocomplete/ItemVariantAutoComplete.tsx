// components/autocomplete/ItemVariantAutoComplete.tsx
...
type ItemVariantAutoCompleteProps = {
  label: string;
  placeholder?: string;
  endpoint: string;
  value: string;
...
export default function ItemVariantAutoComplete({
  label,
  placeholder,
  endpoint,
  value,
  onChange,
}: ItemVariantAutoCompleteProps) {
