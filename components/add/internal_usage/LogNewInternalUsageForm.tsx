          ...
          <div ref={personnelRef} className="relative">
            ...
            <div ref={authorizedRef} className="relative">
              ...
              <input
                type="text"
                value={authorizedBy}
                onFocus={() => setShowAuthorizedDropdown(true)}
                readOnly
                placeholder="Select authorized personnel"
                className="w-full border border-[#d2bda7] p-2 rounded hover:bg-gray-100 cursor-pointer"
              />

              {showAuthorizedDropdown && authorizedPersonnels.length > 0 && (
                <div className="absolute z-50 bg-white border w-full rounded shadow max-h-40 overflow-auto">
                  {authorizedPersonnels.map((p) => (
                    <div
                      key={p.id}
                      onClick={() => {
